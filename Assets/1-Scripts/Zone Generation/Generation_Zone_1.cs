...
public class Generation_Zone_1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        CellArray[5] = Resources.Load("Zone1_Cell_4") as GameObject;

    }

    void Update()
    {
        if (Player.GetComponent<CharacterTriggerManager>().PlayerDistance > 100)
        {
            CellArray[1] = Resources.Load("Zone1_Cell_Zone2Trigger") as GameObject;
            CellArray[3] = Resources.Load("Zone1_Cell_Zone2Trigger") as GameObject;
            CellArray[5] = Resources.Load("Zone1_Cell_Zone2Trigger") as GameObject;
        }
    }
